...
class F1Predictor:
    ...
    def train_model(self):
        ...
        THRESHOLD = 0.55  # <<<<<< You can change this value
    ...
    #     # Precision/Recall/F1 only for test
    ...
    def save_model(self, filename='f1_model_logistic.joblib'):
        if self.model is not None:
            ...
            return "⚠️ No model to save. Train the model first."

    def load_model(self, filename='f1_model_logistic.joblib'):
